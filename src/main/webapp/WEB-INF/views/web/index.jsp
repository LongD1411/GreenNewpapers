            ...
            <div class="row">
                    ...
                    <div class="owl-carousel owl-carousel-2 carousel-item-1 position-relative mb-3 mb-lg-0">
                        <c:forEach var="item" items="${midNewList }">
	                        <div class="position-relative overflow-hidden" style="height: 435px;">
	                            <img class="img-fluid h-100" src="${item.thumbnail}" style="object-fit: cover;">
	                            <div class="overlay">
	                                <div class="mb-1">
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                        ...
                        <a class="text-secondary font-weight-medium text-decoration-none" href="<c:url value='/danh-muc'/>">Xem tất cả</a>
                    </div>
                    <c:forEach var="item" items="${categoryList }">
	                    <div class="position-relative overflow-hidden mb-3" style="height: 80px;">
	                        <img class="img-fluid w-100 h-100" src="${item.thumbnail }" style="object-fit: cover;">
	                        <a href="<c:url value='danh-muc/${item.code}'/>" class="overlay align-items-center justify-content-center h4 m-0 text-white text-decoration-none">${item.name }</a>
	                    </div>
                    </c:forEach>
                </div>
            </div>
